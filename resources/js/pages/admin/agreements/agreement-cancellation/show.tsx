...
export default function ShowAgreementCancellation() {
  const breadcrumbs: BreadcrumbItem[] = [
    ...
    {
      title: 'Ver Baja',
      href: route('agreements.cancellations.show'),
    },
  ];
  ...
  return (
    <AppLayout breadcrumbs={breadcrumbs}>
      <Head title="Ver Baja de Convenio" />
      <AgreementLayout title="Ver Baja de Convenio" description="Ver una baja de convenio para los convenios.">
